...
namespace AmmarMidani\StringSimilarity;
...
class SmithWatermanGotoh
{
     ...
     *
     * @param gapValue a non-positive gap penalty
     * @param substitution a substitution function
     */
    public function __construct(
        ...
        if (empty($substitution)) {
            $this->substitution = new \AmmarMidani\StringSimilarity\SmithWatermanMatchMismatch(1.0, -2.0);
        } else {
